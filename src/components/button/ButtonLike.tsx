...
export const ButtonLike = forwardRef((inProps: ButtonLikeProps, ref: React.Ref<HTMLDivElement>) => {
  ...
  const mainClass = useMemo(() => buttonLikeClassName(size, variant, rounded), [size, variant, rounded]);
...
function buttonLikeClassName(size: TDesignSize, variant: TDesignVariant, rounded: TDesignRounded) {
